...
import uz.rdo.projects.searchbookyandexmap.databinding.ActivityNullMainBinding
import uz.rdo.projects.searchbookyandexmap.utils.metrToKM

@Suppress("DEPRECATED_IDENTITY_EQUALS")
class MainActivityNull : AppCompatActivity() {

    private var _binding: ActivityNullMainBinding? = null
    private val binding: ActivityNullMainBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        _binding = ActivityNullMainBinding.inflate(layoutInflater)
